...
CREATE TABLE products (
  ...
  FOREIGN KEY (categoryId) REFERENCES categories(categoryId)
    ...
    (10,'Scooby-Doo',20.80,'Kids halloween movie','movie2.jpg',12,4),
    (11,'Super Heros',50,'Lego Super heroes 2','movie4.jpg',14,4),
    (12,'Necklace',12.99,'Multi strand necklace','bracelet6.jpg',14,5),
    (13,'Short dress',100,'Ladies midi dress','women2.jpg',24,6),
    (14,'Shoulder bag',40.80,'Women comfort Shoulder bag','women5.jpg',12,6),
    (15,'Ladies high heels',150.80,'Available in various colors','women8.jpg',12,6),
    ...
    (19,'Kada bracelet',35.00,'Shop hand kada bracelet with ring','bracelet1.jpg',4,5),
    (20,'Hugh loafers',50,'Hugh perforated penny loafers','men7.jpg',11,1),
    (21,'Gold Bracelet',20.59,'Gold plated hand bracelet','bracelet3.jpg',7,5),
    (22,'Bracelet Watches',10.00,'Beautiful ladies hand braclet wrist watch','wristwatch3.jpg',3,5),
    (23,'Hp Essential',1000,'Hp Essential personal laptop','laptop2.jpg',4,3),
	(24,'New Mac',2550.80,'Mac for hackering','laptop3.jpg',2,3),
    (25,'Unique watch',9.50,'Suitable for everyone','wristwatch5.jpg',5,5),
    ...
    (29,'Mini necklace',73.38,'Beautiful, attractive mini necklace','bracelet7.jpg',2,5),
...
CREATE TABLE cart (
	cartId int(11) auto_increment PRIMARY KEY,
	userId int(11),
	productId int(11),
...
END$$
DELIMITER ;create database if not exists dbproject;
use dbproject;
